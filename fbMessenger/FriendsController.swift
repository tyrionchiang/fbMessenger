...
extension FriendsController{
    ...
    func setupData(){
        ...
        if let context = delegate?.managedObjectContext{
            ...
            createMessageWithText("夾娃娃大學畢業的", friend: ruu, minutesAgo: 60 * 24, context: context)
            ...
            createMessageWithText("Follow excellence... Success will chase you.", friend: tyrion, minutesAgo: 60 * 24 * 8, context: context)
...
//            messages = [message, messagesteve]
    ...
    private func createStevMessagesWithContext(context: NSManagedObjectContext){
        ...
        createMessageWithText("Absolutely, I'll just use my gigantic iPhone6 Plus until then!!", friend: steve, minutesAgo: 1, context: context, isSender: true)
